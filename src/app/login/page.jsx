        ...
        <Form className="w-full max-w-full flex" onSubmit={onSubmit}>
          <Fieldset className="">
            <div className="flex flex-col items-center">
              ...
              <p className="text-sm text-gray-600 text-center max-w-70 mt-2">
                Login to continue your reading journey and explore thousands of
                books.
              </p>
            </div>
            ...
            <div className="flex w-full ">
              <Button
                className="btn flex items-center w-full bg-[#2563EB] text-[#FFFFFF]"
                type="submit"
              >
                <IoIosLock
