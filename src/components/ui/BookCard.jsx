...
const BookCard = ({ book }) => {
  ...
  return (
    <Card className="animate__animated animate__slideInUp rounded-2xl shadow-md hover:shadow-lg transition duration-300 overflow-hidden p-3 border-2 border-gray-200  ">
